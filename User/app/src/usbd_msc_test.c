			...
			switch (ucKeyCode)
			{
				...
				case KEY_DOWN_K3:		/* K3键按下 */
					/* 重新扫描测试坏块，执行时间很长。 用于NAND 磁盘修复 */
					{
						...
						{
							sprintf(buf, "不要断电,扫描坏块... %d (%d%%)", i, i * 100 / NAND_BLOCK_COUNT);
							LCD_DrawLabel(&FormUSB->Label4);
