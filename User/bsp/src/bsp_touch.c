...
*	文件名称 : bsp_touch.c
*	版    本 : V2.0
*	说    明 : 驱动TS2046芯片 和 RA8875内置触摸， 支持电容触摸FT5x06
*	修改记录 :
*		版本号  日期        作者    说明
...
*		V1.9	2015-10-30 armfly 增加 4.3寸电容触摸 FT5x06
*					(1) 添加 void TOUCH_CapScan(void) 函数
*					(2) 修改 TOUCH_PutKey() 函数
*					(3) g_tTP.Write = g_tTP.Read = 0; 移到电容触摸处理函数之前做，避免电容屏首个触点被忽略。
*		V2.0	2015-12-21 armfly 解决FT电容触摸芯片ID识别错误问题，需要延迟50ms。修改TOUCH_InitHard()函数。
*
