...
*		V1.1	2016-02-01  armfly   修改void FT5X06_Scan(void)函数，STM32F103应用时，可能检测不到抬笔事件。
*									 解决办法，判断 FT5X06_PenInt == 0时，补发一个抬笔的消息。
*
...
/* 定义GPIO端口 */
#define RCC_TP_INT	RCC_APB2Periph_GPIOC
#define PORT_TP_INT	GPIOC
#define PIN_TP_INT	GPIO_Pin_5
